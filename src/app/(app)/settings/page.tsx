...
import { Settings as SettingsIcon, Palette, ShieldCheck, Eye, KeyRound, RefreshCw, Check } from "lucide-react";
...
export default function SettingsPage() {
  ...
  const { data } = useQuery<AdminSettings>({ queryKey: ["settings", "admin"], queryFn: () => api.get("/api/settings") });
  ...
  useEffect(() => {
    if (data) {
      ...
      setPublicViewing(data.publicViewing);
      setAutoLogout(String(data.autoLogoutMinutes));
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <PageHeader title="Settings" description="Manage appearance, security and public visibility." icon={SettingsIcon} />
      ...
      <Tabs defaultValue="appearance">
        ...
        <TabsContent value="appearance" className="space-y-4">
          <Card className="space-y-5 p-6">
            ...
            <Button variant="gradient" onClick={saveGeneral}>Save appearance</Button>
          </Card>
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">Allow anyone to browse your wishlist, charts and search.</p>
              </div>
              <Switch checked={publicViewing} onCheckedChange={(v) => { setPublicViewing(v); }} />
            </div>
            <Button variant="outline" className="mt-4" onClick={saveGeneral}>Apply visibility</Button>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="security" className="space-y-4">
          <Card className="space-y-4 p-6">
            ...
            <Button variant="outline" onClick={saveGeneral}>Save account</Button>
          </Card>
          ...
          <Card className="space-y-4 p-6">
            ...
            <Button variant="gradient" disabled={!currentPassword || newPassword.length < 8} onClick={changePassword}>
              Update password
            </Button>
          </Card>
          ...
          <Card className="space-y-4 p-6">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {data?.hasResetCode ? "A recovery code is active." : "Generate a code to recover access if you’re locked out."}
                </p>
              </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Sign out all other devices immediately.</p>
              </div>
